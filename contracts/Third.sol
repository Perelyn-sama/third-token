...
contract Third is Context, IERC20, Ownable  {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, fees.tFee, fees.tLiquidity, _getRate());
        return (rAmount, rTransferAmount, rFee, fees.tTransferAmount, fees.tFee, fees.tLiquidity);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (Fees memory) {
        ...
        fees.tTransferAmount = tAmount.sub(fees.tFee).sub(fees.tLiquidity);
        return (fees);
    }
